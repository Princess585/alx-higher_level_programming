...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            x (int): x coordinate of the new Rect
            y (int): y coordinate of the new Rect
            id (int): Identity of the new Rect
        Raises:
    ...
    @property
    def height(self):
        """Set/get the height of the Rect"""
    ...
    @property
    def x(self):
        """Set/get the x coordinate of the Rect"""
        return self.__x
    ...
    @property
    def y(self):
        """Set/get the y coordinate of the Rect"""
        return self.__y
    ...
    def to_dictionary(self):
        """Return the dictionary representation of a Rect"""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
