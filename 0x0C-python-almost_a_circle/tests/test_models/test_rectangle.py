...
from models.rectangle import Rect
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for testing initialization of Rect width attr"""
...
class TestRectangle_height(unittest.TestCase):
    ...
    def test_None_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an int"):
            Rectangle(1, None)
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for testing initialization of Rectangle x attr"""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str__ and display methods of Rect class"""
